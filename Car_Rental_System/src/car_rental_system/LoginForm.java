...
public class LoginForm extends JFrame {
    ...
    public LoginForm() {
            ...
            protected void paintComponent(Graphics g) { 
                ...
                try {
                    ...
                    if (imageUrl != null) {
                        ...
                        java.io.File imageFile = new File(imagePath);
                        if (imageFile.exists()) {
        ...
        JLabel subtitleLabel = new JLabel("Experience luxury on every journey");
        subtitleLabel.setFont(new Font("Segoe UI", Font.PLAIN, 18));
        subtitleLabel.setForeground(new Color(220, 220, 220));
        subtitleLabel.setBounds(40, 625, 500, 30);
        ...
        loginTab.setFont(new Font("Segoe UI", Font.BOLD, 15));
        loginTab.setForeground(new Color(33, 150, 243));
        loginTab.setBackground(Color.WHITE);
        loginTab.setBorder(BorderFactory.createMatteBorder(0, 0, 3, 0, new Color(33, 150, 243)));
        ...
        registerTab.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        registerTab.setForeground(new Color(120, 120, 120));
        registerTab.setBackground(Color.WHITE);
        registerTab.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(230, 230, 230)));
        ...
        userLabel.setBounds(120, 270, 100, 20);
        ...
        userFieldPanel.setBounds(120, 295, 310, 48);
        ...
        passLabel.setBounds(120, 365, 100, 20);
        ...
        passFieldPanel.setBounds(120, 390, 310, 48);
        ...
        JButton loginBtn = new RoundedButton("Login", 8);
        loginBtn.setBounds(120, 470, 310, 48);
        ...
        registerPanel.setBounds(120, 540, 310, 30);
    ...
    private void switchToRegister() {
        try {
            ...
            showStyledMessage("Error opening RegisterForm: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
        ...
        try {
            ...
            if (userId != -1) {
                ...
                if ("ADMIN".equalsIgnoreCase(role)) {
                    // AdminDashboard uses no-argument constructor
                    new AdminDashboard().setVisible(true);
                } else {
                    // UserDashboard requires userId and username
                    new UserDashboard(userId, username).setVisible(true);
                }
